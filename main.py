...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/lustre/nvwulf/projects/PrasannaGroup-nvwulf/surya/datasets/histai_processed/curated/selected/features_conch_v15', help='the path to the directory containing the encoded wsi patches.')
    parser.add_argument('--ann_path', type=str, default='/lustre/nvwulf/projects/PrasannaGroup-nvwulf/surya/datasets/histai_processed/curated/histai_reports_splits.json', help='the path to the directory containing the data.')
